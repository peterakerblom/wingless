...
#
	##if pulse_growing:
		##scale += Vector2(1, 1) * pulse_speed * delta
		##if scale.x >= pulse_scale_max:
			##scale = Vector2(pulse_scale_max, pulse_scale_max)
			##pulse_growing = false
	##else:
		##scale -= Vector2(1, 1) * pulse_speed * delta
		##if scale.x <= pulse_scale_min:
			##scale = Vector2(pulse_scale_min, pulse_scale_min)
			##pulse_growing = true
#
